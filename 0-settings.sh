...
eval_echo "[[ \"$JAVA_HOME\" == \"\" ]]  && JAVA_HOME=$ROOT/.jdk"
eval_echo "[[ \"$MAVEN_HOME\" == \"\" ]] && NO_MAVEN=true"
eval_echo "[[ \"$NO_MAVEN\" == "true" ]] && MAVEN_HOME=$ROOT/.mvn"
eval_echo "[[ \"$NO_MAVEN\" == "true" ]] && MAVEN_OPTS=-Dmaven.repo.local=$MAVEN_HOME/repository"
