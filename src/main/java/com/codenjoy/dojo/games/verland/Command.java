...
public class Command {
    ...
    public static final String CURE_AT_LEFT = CURE_AT.apply(LEFT);
    public static final String CURE_AT_RIGHT = CURE_AT.apply(RIGHT);
    public static final String CURE_AT_UP = CURE_AT.apply(UP);
    public static final String CURE_AT_DOWN = CURE_AT.apply(DOWN);
}
